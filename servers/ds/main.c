...
FORWARD void init_server(int argc, char **argv);
FORWARD void exit_server(void);
FORWARD void sig_handler(void);
FORWARD void get_work(message *m_ptr);
FORWARD void reply(int whom, message *m_ptr);
