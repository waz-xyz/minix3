...
int vfscanf(FILE *_stream, const char *_format, va_list _arg);
int vscanf(const char *_format, va_list _arg);
int vsscanf(const char *_s, const char *_format, va_list _arg);
...
int vsnprintf(char *_s, size_t _n, const char *_format, va_list _arg);
