...
#define	KERNEL_FIRST_LEVEL_TT_SIZE		0x4000
#define	KERNEL_FIRST_LEVEL_TT_ALIGN		(KERNEL_FIRST_LEVEL_TT_SIZE - 1)
#define	KERNEL_FIRST_LEVEL_TT_NOF_ENTRIES	(KERNEL_FIRST_LEVEL_TT_SIZE / 4)
#define	USER_FIRST_LEVEL_TT_SIZE		0x4000
#define	USER_FIRST_LEVEL_TT_ALIGN		(USER_FIRST_LEVEL_TT_SIZE - 1)
